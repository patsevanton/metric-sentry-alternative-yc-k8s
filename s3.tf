...
resource "yandex_iam_service_account_static_access_key" "sa_storage_admin_static_key" {
  ...
  description        = "static access key for Metric BlobStore (S3)"
}

resource "yandex_storage_bucket" "metric_blobs" {
...
output "access_key_sa_storage_admin_for_bucket" {
  description = "access_key sa-storage-admin for the Metric BlobStore bucket"
...
output "secret_key_sa_storage_admin_for_bucket" {
  description = "secret_key sa-storage-admin for the Metric BlobStore bucket"
